...
public class LayerModDeadmau5Head implements LayerRenderer<AbstractClientPlayer>
{
    private final RenderModPlayer playerRenderer;

    public LayerModDeadmau5Head(RenderModPlayer playerRendererIn)
    {
