...
public class GuiAccessories extends GuiContainer {
	...
	private static final ResourceLocation inventoryBackground = new ResourceLocation(BroadAdditionsMod.MODID,"textures/gui/inventory_accessories.png");

	private final InventoryAccessories inventory;

	public GuiAccessories(EntityPlayer player, InventoryPlayer inventoryPlayer, InventoryAccessories inventoryCustom) {
