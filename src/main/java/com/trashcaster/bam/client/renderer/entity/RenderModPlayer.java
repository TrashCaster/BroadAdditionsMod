...
import com.trashcaster.bam.client.model.ModelModPlayer;
import com.trashcaster.bam.client.renderer.entity.layers.LayerModCape;
import com.trashcaster.bam.client.renderer.entity.layers.LayerModDeadmau5Head;
...
public class RenderModPlayer extends RendererLivingEntity<AbstractClientPlayer>
{
    ...
    public RenderModPlayer(RenderManager renderManager, boolean useSmallArms)
    {
        super(renderManager, new ModelModPlayer(0.0F, useSmallArms), 0.5F);
        this.smallArms = useSmallArms;
        this.addLayer(new LayerBipedArmor(this));
        this.addLayer(new LayerHeldItem(this));
        this.addLayer(new LayerArrow(this));
        this.addLayer(new LayerModDeadmau5Head(this));
        this.addLayer(new LayerModCape(this));
        this.addLayer(new LayerCustomHead(this.getMainModel().bipedHead));
    }

    public ModelModPlayer getMainModel()
    {
        return (ModelModPlayer)super.getMainModel();
    }
    ...
    {
    	ModelModPlayer modelplayer = this.getMainModel();
